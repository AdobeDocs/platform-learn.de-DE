...
Interessant ist auch, dass Sie bereits definierte Segmente einfach in Adobe Experience Platform wiederverwenden können, indem Sie zu **Zielgruppen** > ``--aepTenantIdSchema--`` navigieren.
