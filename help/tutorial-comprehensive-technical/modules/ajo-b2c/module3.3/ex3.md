...
In [Erste Schritte](./../../../modules/gettingstarted/gettingstarted/ex2.md) haben Sie Ihren eigenen **Datenstrom** erstellt. Sie haben dann den Namen `--aepUserLdap-- - Demo System Datastream` verwendet.
