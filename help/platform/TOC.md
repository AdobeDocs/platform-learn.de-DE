...
+ Zielgruppen und Segmentierung {#audiences}
   ...
   + [Einrichten der Verbindung zwischen Segmentübereinstimmungen](/help/platform/segments/segment-match-connection-setup.md)
   + [Data Governance bei Segmentübereinstimmungen](/help/platform/segments/segment-match-data-governance.md)
   + [Konfigurationsfluss für Segmentübereinstimmungen](/help/platform/segments/segment-match-configuration-flow.md)
...
+ Data Science Workspace {#data-science-workspace}
   ...
   + [Daten in JupyterLab-Notebooks laden](data-science-workspace/load-data-in-jupyterlab-notebooks.md)
...
+ Identitäten {#identities}
   ...
   + [Identitätsdiagramme anzeigen](/help/platform/identities/view-identity-graphs.md)
...
+ Datenschutz und Sicherheit {#privacy}
   ...
   + [10 Überlegungen zum verantwortungsvollen Customer Data Management](/help/platform/privacy/ten-considerations-for-responsible-customer-data-management.md)
...
+ Schemata {#schemas}
   ...
   + [Datenmodell planen](/help/platform/schemas/plan-your-data-model.md)
   ...
   + [Klassen erstellen](/help/platform/schemas/create-classes.md)
   ...
   + [Beziehungen zwischen Schemata konfigurieren](/help/platform/schemas/configure-relationships-between-schemas.md)
   + [Aufzählungsfelder und empfohlene Werte verwenden](/help/platform/schemas/use-enumerated-fields.md)
   + [Kopieren von Schemata zwischen Sandboxes](/help/platform/schemas/copy-schemas-between-sandboxes.md)
...
+ Quellen {#sources}
   ...
   + [Daten aus Datenbanken erfassen](/help/platform/sources/ingest-data-from-databases.md)
