...
# Verwenden von Adobe-APIs in Workfront Fusion

Erfahren Sie, wie Sie Adobe-APIs in Workfront Fusion verwenden.

## Verwenden der Firefly-Text-zu-Bild-API mit Workfront Fusion
...
## Verwenden der Photoshop-API mit Workfront Fusion
...
1. Deaktivieren Sie vor dem Fortsetzen der Photoshop-API-Interaktionen die Route zum Knoten **Firefly T2I**, um nicht benötigte API-Aufrufe an diesen API-Endpunkt zu senden. Wählen Sie das **Schraubenschlüssel**-Symbol aus und wählen Sie dann **Route deaktivieren**.
