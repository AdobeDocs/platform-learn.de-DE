...
Vor diesem Tutorial müssen die folgenden Anwendungen auf Ihrem Computer installiert sein:

- Adobe Creative Cloud
- Photoshop 2025
- Postman

## 1. Installieren der Chrome-Erweiterung für die Experience League-Dokumentation

### Über die Chrome-Erweiterung

Die Dokumentation wurde allgemein gehalten, sodass sie von jedem mithilfe einer beliebigen Adobe-Instanz einfach wiederverwendet werden kann.
...
| Name | Schlüssel |
|:-------------:| :---------------:|
| Kennung der IMS-Organisation | `--aepImsOrgId--` |
