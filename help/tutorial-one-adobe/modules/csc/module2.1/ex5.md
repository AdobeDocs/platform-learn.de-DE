...
## 2.1.5.2 Hinzufügen von Logik und Laden von Daten von einem externen Endpunkt

Für diese Übung werden Sie eine „Raw“-Konfiguration von Adobe Web SDK durchführen und das nächstbeste Angebot von Adobe Journey Optimizer Offer decisioning anfordern.
...
Die Bibliothek **alloy.js** ist die Bibliothek von Web SDK, die es ermöglicht, Anfragen von einer Website an ein Adobe-Edge Network zu senden und von dort aus Programme wie Adobe Experience Platform, Adobe Analytics, Adobe Target und mehr.
...
Das zweite Skript-Tag (script2) lädt asynchron die Bibliothek alloy.js aus dem CDN der Adobe.
...
In der Anfrage werden zwei **Entscheidungsumfänge** angegeben, in denen Adobe Journey Optimizer Offer decisioning aufgefordert wird, eine Entscheidung darüber zu geben, welches Angebot von dieser ECID angezeigt werden muss.
