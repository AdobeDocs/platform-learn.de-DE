---
title: Datenerfassung - FAC - Einrichten des Snowflake-Kontos
...
# 1.3.1 Einrichten der Snowflake-Umgebung

## 1.3.1.1 Konto erstellen
...
Anschließend werden Sie bei Snowflake angemeldet. Klicken Sie **Vorerst überspringen**.

![FAC](./images/sf7.png)

## 1.3.1.2 Datenbank erstellen
...
## 1.3.1.3 Erstellen von Tabellen
...
## 1.3.1.4 Aufnehmen von Beispieldaten

Sie können jetzt mit dem Laden von Beispieldaten in Ihre Datenbank beginnen.

Klicken Sie auf **+ Erstellen** und wählen Sie dann **SQL-Arbeitsblatt**.
...
Kopieren Sie die folgende Abfrage und fügen Sie sie in das Snowflake-Arbeitsblatt ein.
...
Sie sollten das dann sehen. Klicken Sie, um die **Dropdown**-Liste zu öffnen, und wählen Sie dann **Alle ausführen**, um alle Abfragen auszuführen.

![FAC](./images/dataload3.png)

Dies wird einige Minuten dauern und danach werden Sie dies sehen.

![FAC](./images/dataload4.png)

Sie haben jetzt Demodaten in Ihre Snowflake-Datenbank geladen. Sie können die darin enthaltenen Daten durch Öffnen einer beliebigen Tabelle untersuchen

Sie haben jetzt die Einrichtung in Snowflake abgeschlossen.

![FAC](./images/dataload5.png)

## Nächste Schritte

Navigieren Sie zu [1.3.2 Erstellen von Schemata, Datenmodellen und Links](./ex2.md){target="_blank"}
