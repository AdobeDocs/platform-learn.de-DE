...
# 3.3.3 Vorbereiten der Client-Eigenschaft für die Datenerfassung in Adobe Experience Platform und des Web-SDK-Setups für Offer Decisioning
...
Ihr **Datenstrom** kann jetzt mit **Offer Decisioning** verwendet werden.
...
Jedes Mal, wenn Sie jetzt eine **Allgemeine Seite** laden, z. B. die Startseite der Demo-Website, bewertet Offer Decisioning das passende Angebot und gibt eine Antwort mit den Details des anzuzeigenden Angebots an die Website zurück. Das Anzeigen des Angebots auf der Website erfordert eine zusätzliche Konfiguration, die Sie im nächsten Schritt durchführen werden.
...
Mit dieser Änderung überwacht diese Regel in der Adobe Experience Platform-Datenerfassung jetzt die Antwort von Offer Decisioning, die Teil der Web-SDK-Antwort ist, und wenn die Antwort empfangen wird, wird das Bild des Angebots auf der Homepage angezeigt.
...
- 1 Implementierung von Offer Decisioning mithilfe Ihrer Datenerfassungseigenschaft
...
Navigieren Sie zu [3.3.4 Adobe Target und Offer Decisioning kombinieren](./ex4.md){target="_blank"}
