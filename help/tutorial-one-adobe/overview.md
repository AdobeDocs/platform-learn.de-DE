...
- Wenn Sie das Modul [Creative Workflow-Automatisierung mit Workfront Fusion](./modules/creation-production/module1.2/automation.md){target="_blank"} abschließen, können Sie die **Adobe Qualified**-Prüfung (AD2-**E902)**:
...
[1.1 Adobe Workfront-Planung](./modules/workflow-planning/module1.1/wfplanning.md){target="_blank"}
...
In diesem Modul verwenden Sie Adobe Workfront Fusion, um Ihre Workflows zur Inhaltserstellung zu automatisieren und zu skalieren.
...
[1.7 Benutzerdefinierte Firefly-Workflows](./modules/creation-production/module1.7/workflowbuilder.md){target="_blank"}

In diesem Modul verwenden Sie benutzerdefinierte Workflows in Firefly, um wiederholbare Anwendungsfälle für kreatives Design und Automatisierung zu lösen.
...
[1.3 Adobe Experience Manager Forms mit Edge Delivery Services](./modules/asset-mgmt/module1.3/aemforms.md){target="_blank"}

In diesem Modul lernen Sie Adobe Experience Manager Forms mit Edge Delivery Services kennen.
...
In diesem Modul erstellen Sie Ihre Adobe Commerce as a Cloud Service-Instanz. Sie verbinden Ihre Commerce-Instanz mit Ihrer AEM Sites CS-Storefront und Ihrer AEM Assets CS-Umgebung.
