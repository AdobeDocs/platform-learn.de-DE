...
Im nächsten Schritt wird Ihre Abfrage (auch bekannt als **Erstellen einer Tabelle nach Auswahl** oder **CTAS**) als neuen Datensatz, den Sie in Microsoft Power BI verwenden werden.
