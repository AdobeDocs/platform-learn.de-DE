---
title: Customer Journey Analytics - Visualisierung mit Customer Journey Analytics
description: Customer Journey Analytics - Visualisierung mit Customer Journey Analytics
kt: 5342
...
# 11.5 Visualisierung mit Customer Journey Analytics
...
Verwenden wir das Projekt, das Sie in [11.4 Datenvorbereitung in Analysis Workspace](./ex4.md), also gehen Sie zu [https://analytics.adobe.com](https://analytics.adobe.com).

![Demo](./images/prohome.png)

Öffnen Sie Ihr Projekt `--demoProfileLdap-- - Omnichannel Analysis`.

Mit geöffnetem Projekt und Datenansicht `--demoProfileLdap-- - Omnichannel Analysis` ausgewählt haben, können Sie mit der Erstellung Ihrer ersten Visualisierungen beginnen.
...
Wählen Sie als Nächstes in der Tabelle die ersten 5 **Benutzeragent**  Zeilen aus der Aufschlüsselung, die wir unter **Google Pixel XL 32 GB Black Smartphone** > **Citi Signal**. Halten Sie bei Auswahl der drei Zeilen die **STRG** (unter Windows) oder **Befehl** Schaltfläche (in Mac).
