---
title: Customer Journey Analytics - Adobe Experience Platform-Datensätze in Customer Journey Analytics verbinden
description: Customer Journey Analytics - Adobe Experience Platform-Datensätze in Customer Journey Analytics verbinden
kt: 5342
...
# 11.2 Adobe Experience Platform-Datensätze in Customer Journey Analytics verbinden
...
Bitte verwenden Sie diese Namenskonvention: `--demoProfileLdap-- – Omnichannel Data Connection`.
...
## 11.2.2 Adobe Experience Platform-Datensätze auswählen
...
## 11.2.3 Personen-ID und Datenzuordnung
...
Nächster Schritt: [11.3 Datenansicht erstellen](./ex3.md)
