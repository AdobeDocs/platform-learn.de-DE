...
* **Implementieren von Adobe Target**. Target wird noch nicht mit der mit einer mobilen Eigenschaft verknüpften Datastream-Konfiguration unterstützt, kann jedoch mithilfe der Variablen [Adobe Target-Erweiterung](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/adobe-target).
