...
+ [Tutorial für Datenarchitekten und -ingenieure](overview.md)
+ [1. Konfigurieren von Berechtigungen](configure-permissions.md)
+ [2. Erstellen einer Sandbox](create-a-sandbox.md)
...
+ [5. Zuordnen von Identitäten](map-identities.md)
...
+ [9. Aufnehmen von Batch-Daten](ingest-batch-data.md)
+ [10. Aufnehmen von Streaming-Daten](ingest-streaming-data.md)
+ [11. Erstellen von Zusammenführungsrichtlinien](create-merge-policies.md)
+ [12. Anwendung des Data Governance-Rahmens](apply-data-governance-framework.md)
+ [13. Abfragen ausführen](run-queries.md)
+ [14. Erstellen von Segmenten](build-segments.md)
