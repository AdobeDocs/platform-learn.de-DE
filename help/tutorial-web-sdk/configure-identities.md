...
1. Wählen Sie **[!UICONTROL Namespaces]**
...
1. Geben Sie die Details wie folgt an und wählen Sie **[!UICONTROL Erstellen]**.
   ...
   Der neue Identity-Namespace sollte auf dem Bildschirm **[!UICONTROL Namespaces]** angezeigt werden.

   ![Namespace erstellt](assets/configure-identities-namespace-lumaCrmId.png)


>[!NOTE]
>
> In der Lektion [Identitäten erfassen](create-identities.md) erfahren Sie, wie Sie diesen Namespace verwenden, wenn Sie Identitäten an Platform Edge Network senden.
