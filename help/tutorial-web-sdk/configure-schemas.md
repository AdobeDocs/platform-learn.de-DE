...
* Erstellen eines XDM-Schemas in der Datenerfassungs-Oberfläche
...
1. Stellen Sie sicher, dass Sie sich in der richtigen Sandbox befinden. Suchen Sie die Sandbox in der oberen rechten Ecke
   ...
   >[!NOTE]
   >
   >Wenn Sie Kunde einer Platform-Anwendung wie Real-Time CDP oder Journey Optimizer sind, empfehlen wir Ihnen, für dieses Tutorial eine neue Entwicklungs-Sandbox zu verwenden. Wenn Sie nicht Kunde einer Platform-Anwendung sind, verwenden Sie die **[!UICONTROL Prod]**-Sandbox.
