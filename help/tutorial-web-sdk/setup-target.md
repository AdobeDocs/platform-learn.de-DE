...
>[!NOTE]
>
>In diesem Tutorial wird die [Luma-Website](https://luma.enablementadobe.com){target=_blank} verwendet, die über eine asynchrone Implementierung von Tags und Flimmerschutz verfügt. Dieser Abschnitt dient als Referenz, um zu verstehen, wie die Flimmerreduzierung mit Platform Web SDK funktioniert.
...
1. Navigieren Sie zur [Demo-Website von Luma](https://luma.enablementadobe.com)
