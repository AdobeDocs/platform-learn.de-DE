...
Wenn Sie Traffic auf der [Demo-Site von Luma](https://luma.enablementadobe.com) generieren, der Ihrer Tag-Eigenschaft zugeordnet ist, befüllen die Daten den Datensatz in Experience Platform!
...
1. Öffnen Sie die [Demo-Site von Luma](https://luma.enablementadobe.com) und wählen Sie das Erweiterungssymbol [!UICONTROL Experience Platform Debugger] aus
