...
In dieser Übung erstellen Sie ein XDM-Schema mit den empfohlenen grundlegenden Feldergruppen für die Erfassung von Web-Ereignisdaten auf der [Demo-Site von Luma](https://newluma.enablementadobe.com){target="_blank"}:
