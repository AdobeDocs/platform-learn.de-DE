...
1. Anschließend senden Sie die Überschreibungen entweder per Web SDK-Sendeereignisaktion oder durch eine Konfiguration in der Web SDK-Tag-Erweiterung an das Edge Network.
